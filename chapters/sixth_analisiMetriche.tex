...
Pecr iascuna metrica di interesse non è stata considerata una singola esecuzione,
...
interquartile, compreso tra primo e terzo quartile, mentre la banda esterna
...
con intervallo interquartile e banda p10--p90, in quanto più adatti a
...
ms. Il delay medio è ~15.5 ms, con mediana 16.5 ms e un intervallo interquartile di
~5.18 ms. L'IQR lungo la curva è ~5.62 ms e la p10–p90 ~10.0 ms.
Complessiavmente l'andamento rimane leggibile e non ha instabilità estrema, evidenziando
comunque un peggioramento generale.

Nello scenario \texttt{high} si ha un comportamento con più degrado e meno
regolare. Post peer-seelection, la curva media si posiziona in fase iniziale su
...
aumento dell'livello medio e della variabilità.

Nello scenario \texttt{low} il valore medio risulta ~1.05 ms, con una dispersione
moderata. La banda interquartile media della curva aggregata è pari a ~0.65 ms,
...
aumento della dispersione, con banda interquartile media di ~2.40 ms e banda p10--p90
di ~4.18 ms.
...
centrale di $-2.55\,\mathrm{ms}$, invece l’ampiezza banda interquartile è di ~($\mathrm{IQR}
...
L’ampiezza media della banda interquartile è di ~$15 .17\,\mathrm{ms}$, La
...
In tutti e tre gli scenari, in molteplici punti, la curva media è esterna alla banda interquartile.
