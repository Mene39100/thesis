...
Una precisazione aggiuntiva è necessaria: nel seguito del capitolo verranno utilizzati talvolta
elementi descrittivi che possono indicare stabilità o regolarità per indicare una limitata 
variazione temporale delle metriche osservate. Ciò non va intesa da sola come elevata accuratezza oppure
un assenza di condizioni anomale. Si considera quindi congiuntamente il livello medio della metrica,
 la dispersione tra le run e gli indicatori di stato disponibili. 
I criteri di selezione dei campioni operativi si applicano ai riepiloghi per singola run nei casi specificati nel Capitolo 5, 
mentre le serie aggregate possono includere anche le fasi transitorie iniziali.
