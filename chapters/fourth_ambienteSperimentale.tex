...
containerizzata attraverso l'ausilio di Kathará, cioè un sistema di emulazione di
...
applicata come root. Diversamente la seconda è stata agganciata come qdisc figlia
...
Nota: \texttt{printf "\%02d"}serve a numerare le run, formattando le directory
rendendo più complesibile l'attività di logging.
...
Il file \texttt{chrony\_tracking\_series.txt} contiene lo stato del tracking del client
Chrony. Il file \texttt{chrony\_sources\_series.txt} riporta le sorgenti viste dal
client e il loro stato. Il file \texttt{chrony\_sourcestats\_series.txt} contiene
le statistiche associate alla sorgente, mentre \texttt{chrony\_activity\_series.txt}
descrive lo stato di attività delle sorgenti.
