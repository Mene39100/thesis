...
quali \texttt{chrony}, \texttt{ntpsec} e \texttt{linuxptp}, e l'aggiornametno 
...
\texttt{tc qdisc replace} è un comado utilizzato per sostituire o per creare in
...
vegono quindi gestiti direttamente dallo script princpale. Lo stesso avviene per
...
Nella seguente tabella venogno riportati i parametri utilizzati~\ref{tab:parametri-degrado}.
...
applicato gli impairmentsull'interfaccia \texttt{eth1} del nodo \texttt{boundary}.
...
\end{listing}
Nella parte del main Bash, si ha un eseguzione sistematica di tutte le
...
Nella dirctory PTP i file prodotti sono lo stato della qdisc e i tre log dei processi.
