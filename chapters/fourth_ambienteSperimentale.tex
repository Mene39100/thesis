...
agli script di scrivere i log in una directory persistente accessibile dal host,
...
di Linux Traffic Control. La topologia di rete è rimasta invariata in tutte la run,
...
agganciandola al parent \texttt{1:}, riuscendo cosi ad introdurre sia
...
Questo asseconda la logica di \texttt{qdisc} che si applica sulla traffico in uscita
...
Il flusso logico di esecuzione del testbed è realizzato con un script Bash
...
tipo, e soprattuto si è garantito interferenza tra processi residui o
